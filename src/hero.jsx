    ...
    return (
        ...
        <div className="flex flex-col justify-between items-center p-10">
            ...
            <div className="flex flex-row justify-center md:justify-between items-center gap-6 mt-6">
                <button className="px-4 py-2 bg-blue-600 text-white rounded">View Projects</button>
                <button className="px-4 py-2 border border-gray-300 rounded">Contact Me</button>
            </div>
        </div>
        </>
    );
