export default function Hero(){
    return (
        <section id="home">
        <div className="flex flex-col justify-between items-center py-20 px-6">
            ...
            <div className="flex flex-row justify-center md:justify-between items-center gap-6 mt-6">
                <button className="px-4 py-2 bg-slate-800 text-white rounded transition-colors duration-300 hover:bg-slate-900 active:bg-blue-900"> View Projects</button>
